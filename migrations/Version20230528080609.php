 ...
 */
final class Version20230528080609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__escape_object AS SELECT id, action_id, in_room, name, info, position_x, position_y, img, size_x, size_y, in_object, info_inner, hidden FROM escape_object');
        ...
        $this->addSql('INSERT INTO escape_object (id, action_id, in_room, name, info, position_x, position_y, img, size_x, size_y, in_object, info_inner, hidden) SELECT id, action_id, in_room, name, info, position_x, position_y, img, size_x, size_y, in_object, info_inner, hidden FROM __temp__escape_object');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE escape_movement ADD COLUMN room_id INTEGER NOT NULL');
